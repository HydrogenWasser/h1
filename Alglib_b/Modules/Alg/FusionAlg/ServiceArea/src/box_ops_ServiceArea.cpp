...
*/
xt::xarray<float> box_ops_ServiceArea::corners_nd(xt::xarray<float> &dims, 
                                                  float             origin) 
{
...
*/
xt::xarray<float> box_ops_ServiceArea::rotation_2d(xt::xarray<float>        &corners, 
...
*       [type] : [description]
*/
xt::xarray<float> box_ops_ServiceArea::center_to_corner_box2d(xt::xarray<float> &centers, 
                                                              xt::xarray<float> &dims,
                                                              xt::xarray<float> &angles, 
                                                              float             origin) 
{
//    std::cout<<dims<<"\n";
    xt::xarray<float> corners = box_ops_ServiceArea::corners_nd(dims, origin);

    if (angles.size())
        corners = box_ops_ServiceArea::rotation_2d(corners, angles);
...
*       [type] : [description]
*/
xt::xarray<float> box_ops_ServiceArea::center_to_corner_box3d(xt::xarray<float> &centers, 
                                                              xt::xarray<float> &dims,
                                                              float &angles, 
                                                              float origin, 
                                                              int axis) 
{
    ...
    if (angles != float (None))
        box_ops_ServiceArea::rotation_3d_in_axis(corners, angles, axis);
...
xt::xarray<float> box_ops_ServiceArea::corner_to_standup_nd(xt::xarray<float> &boxes_corner) 
{
...
std::pair<xt::xarray<float>, xt::xarray<float>> box_ops_ServiceArea::rotate_nms_cc(xt::xarray<float> &dets,
                                                                                   xt::xarray<float> &trackers) 
{
    ...
    xt::xarray<float> trackers_corners = box_ops_ServiceArea::center_to_corner_box2d(t1, t2, t3);
    xt::xarray<float> trackers_standup = box_ops_ServiceArea::corner_to_standup_nd(trackers_corners);
    ...
    xt::xarray<float> dets_corners = box_ops_ServiceArea::center_to_corner_box2d(d1, d2, d3);
    xt::xarray<float> dets_standup = box_ops_ServiceArea::corner_to_standup_nd(dets_corners);

    return box_ops_ServiceArea::iou_jit_new(dets_standup, trackers_standup, 0.0);
}


float box_ops_ServiceArea::cal_angle(std::vector<xt::xarray<float>> &state_list, 
                                     float                          &thresh) 
{
...
std::pair<xt::xarray<float>, xt::xarray<float>> box_ops_ServiceArea::iou_jit_new(xt::xarray<float>   &boxes,
...
void box_ops_ServiceArea::rotation_3d_in_axis(xt::xarray<float> &points, 
                                              float             &angles, 
                                              int               axis) 
{
...
*/
float box_ops_ServiceArea::IOU_calc(xt::xarray<float>    box1, 
