...
#ifndef TPCRESULT_SERVICEAREA_H
#define TPCRESULT_SERVICEAREA_H
...
struct TPcResult_ServiceArea
{
	...
	std::vector<TPcBoxInfo_ServiceArea> m_vecBox;		//目标框集
};




#endif // TPCRESULT_SERVICEAREA_H
