...
namespace FunctionHub
{
    ...
    int pcClass2label(const std::string &p_strClass, nlohmann::json *m_fusion_parameter);

    int videoClass2label(const std::string &p_strClass, nlohmann::json *m_fusion_parameter);
