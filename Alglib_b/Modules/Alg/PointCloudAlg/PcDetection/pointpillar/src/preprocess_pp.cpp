...
//              && points[i * num_features + 1] >= point_cloud_range[1] &&
//              points[i * num_features + 1] < point_cloud_range[4]
//              && points[i * num_features + 2] >= point_cloud_range[2] &&
//              points[i * num_features + 2] < point_cloud_range[5]
//        )) {
//            continue;
//        }
//
